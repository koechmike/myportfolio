    ...
    <div className="h-screen flex flex-col space-y-4 items-center justify-center text-center overflow-x-hidden z-10">
      ...
      <div className='z-20'>
        ...
        <div className='pt-5 xl:space-x-3 md:space-x-2'>
          ...
          <Link href="#experience"><motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9}} transition={{ duration: 0.005 }} className='heroButton'>Experience</motion.button></Link>
